      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E2E8F0] pb-5">
        <div>
          ...
          <p className="text-xs text-[#64748B] mt-1">
            ...
            <strong className="text-[#0F172A]">{currentBusiness.brand_name}</strong>. Resolver casos a tiempo protege tu Pasaporte Comercial.
          </p>
        </div>

        <div className="flex items-center gap-4 text-xs">
          <div className="p-2.5 rounded-xl bg-white border border-[#E2E8F0] shadow-xs flex items-center gap-2.5">
            <Clock className="h-4 w-4 text-emerald-600" />
            <div>
              <div className="text-[#64748B] text-[10px]">Tiempo Mediano de Respuesta</div>
              <div className="font-bold text-[#0F172A] font-mono">
          ...
          <div className="p-2.5 rounded-xl bg-white border border-[#E2E8F0] shadow-xs flex items-center gap-2.5">
            ...
            <div>
              <div className="text-[#64748B] text-[10px]">Tasa de Resolución Confirmada</div>
