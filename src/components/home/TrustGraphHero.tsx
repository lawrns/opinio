    ...
    <section className="border-b border-op-border">
      <div className="op-container grid items-center gap-12 py-12 md:py-16 lg:grid-cols-[1.2fr_0.85fr] lg:gap-20 lg:py-20">
        <div>
          ...
          <h1 className="max-w-2xl text-[clamp(2.75rem,5vw,4.5rem)] font-semibold leading-[1.06] tracking-[-0.065em]">Antes de comprar,<br />conoce a quién<br /><span className="text-op-green">le compras.</span></h1>
